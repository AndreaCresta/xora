    ...
    <section>
      <Element name="pricing">
        <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-lg text-center text-p4 max-md:pb-11 max-sm:max-w-sm">
            <h3 className="h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm">Prezzo flessibile per team di qualunque dimensione.</h3>

            <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s2/50 p-2 backdrop-blur-[6px] max-md:w-[310px]">
            ...
            <div className="pricing-bg">
              ...
              <img src="/images/bg-outlines-fill.png" alt="outline" width={960} height={380} className="absolute inset-0 opacity-5"/>
            </div>
          </div>

          <div className="scroll-hide relative z-2 -mt-12 flex items-start justify-center max-xl:overflow-auto max-xl:pt-6">
            {plans.map((plan, index) => (
                <div key={plan.id} className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]">
                  ...
                  <div className={clsx("absolute left-0 right-0 z-2 flex item-center justify-center", index === 1 ? "-top-6" : "-top-6 xl:-top-11")}
                  >
                  ...
                  {index === 1 && (
                      <p className="small-compact mt-9 text-center text-p3 before:mx-2.5 before:content-['-'] after:mx-2.5 after:content-['-']">Offerta a tempo limitato</p>
                    )}
