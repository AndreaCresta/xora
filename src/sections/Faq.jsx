        ...
        <section>
            <Element name="faq" className="relative">
                <div className="container relative z-2 py-28">
                    <div>
                        <h3 className="h3 max-md:h5 max-w-640 max-lg:max-w-md mb-7 text-p4"> La curiosità non è mai abbastanza.</h3>
                        <p className=" body-1 max-lg:max-w-sm">Voi avete le domande, noi abbiamo le risposte.</p>
                    </div>
