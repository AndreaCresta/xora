...
const Hero = () => {
  return (
    <section className="relative pt-60 pb-40 max-lg:pt-20 max-lg:pb-36 max-md:pt-36 max-md:pb-32">
        <Element name="hero">
            <div className="container">
                <div className="relative z-2 max-w-512 max-lg:max-w-388">
                    ...
                    <p className="max-w-440 mb-14 body-1 max-md:mb-10">We designed XORA AI Video Editor to make video editing simple and fun.</p>
